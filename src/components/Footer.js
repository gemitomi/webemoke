      ...
      <section class="footer">
        <div class="box-container">
          ...
          <div class="box">
              ...
              <a href="#"> <i class="fas fa-envelope"></i> bekes.emoke@gmail.com</a>
              <a href="#"> <i class="fas fa-map"></i> Budaörs, Napsugár sétány 4. II/13.</a>
          </div>

          <div class="box">
              <a href="https://hu-hu.facebook.com/people/B%C3%A9k%C3%A9s-Em%C5%91ke-csal%C3%A1dk%C3%ADs%C3%A9r%C5%91-d%C3%BAla/100042636705062/"> <i class="facebook"><SocialLinks/></i></a>
          </div>
        </div>
