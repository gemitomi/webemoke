...
import Pic0 from "../../../image/blog/blog_01_hero_ki a dula.png";
  ...
  <div>
    ...
    <div className="blog-global-container">
        <div className="blog-global-hero">
            <img src={Pic0} alt="Ki a dula es miben segit"/>
        </div>

        <div className="blog-global-face">
            <h2 className="blog-global-title">Ki a dúla és miben segít?</h2>
            ...
            <div className="blog-globale-column">
                <div className="blog-globale-img-container">
                    <img src={Pic1} alt="Ki a dula es miben segit"/>
                </div>
            ...
            <h4>A DÚLA SZÓ A GÖRÖG NYELBŐL ERED</h4>
            ...
            <div className="blog-globale-column">
                <div className="blog-globale-img-container">
                    <img src={Pic2} alt="Ki a dula es miben segit"/>
                </div>
            ...
            <h4>A MAGYARORSZÁGI DÚLASÁG KIALAKULÁSA</h4>
            ...
            <h4>HOGYAN VÁLIK VALAKI DÚLÁVÁ?</h4>
