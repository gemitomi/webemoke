  ...
  return (
    <div>
        ...
        <section className="about1">
            <div className="image">
                ...
                <div className="col-right">
                    ...
                    <p className="text">három gyermekes anya, nő, szerető társ, a
        ...
        <div className="content1">
            ...
            <p className="text">Kísérésem igény szerint a gyermekágy időszakában vagy akár még később is tart, mivel a szülők gyakran fordulnak hozzám a családdá válás folyamán 
            ...
            <p className="text">Ha nem csak olvasnál rólam, hanem szívesen meg is hallgatnád, hogyan, miért lettem dúla és mit ad nekem ez a csodálatos hivatás, 
