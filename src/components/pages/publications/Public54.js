...
import Public54Pic1 from "../../../image/publications/public-54-hero-szeretnek-szepen-szulni.png";
import Public54Pic2 from "../../../image/publications/public-54-szeretnek-szepen-szulni.png";

export default function Public54() {
  return (
  <div>
    <section className="section-blog-global">
        <div className="blog-global-container">
            <div className="blog-global-hero">
                <img src={Public54Pic1} alt="szeretnek-szepen-szulni"/>
            </div>

            <div className="blog-global-face">
                <h2 className="blog-global-title">Szeretnék szépen szülni</h2>
                ...
                <div className="blog-globale-column">
                    <div className="blog-globale-img-container">
                        <img src={Public54Pic2} alt="szeretnek-szepen-szulni"/>
                    </div>
                    <div className="blog-globale-text">
                        ...
                        <blockquote>
                            <i>A napokban derült ki, hogy babát várok. Nagyon izgulok, örülök, ugyanakkor kicsit meg is szeppentem. Ez lesz az első babánk.

                                <br/>Nemrég olvastam a Gyógyító szülés című cikkedet. Én is szeretnék meghitten szülni. Az a kép él bennem, hogy a szülés csodás dolog és fantasztikus élmény. Szeretnék a saját tempómban úgy vajúdni, ahogy kényelmes. Sajnos a barátnőimtől semmi ilyet nem hallok. Ők csak a szülőszékről, az EDA-ról, a fájdalomról és a szenvedésről meséltek.
                                
                                <br/>Hogy lehet felkészülni arra, hogy a szülésem nagy eséllyel élmény legyen, ne kínlódás és szükséges rossz?<br/>
                                <br/>Segítségedet előre is köszönöm!<br/>Niki</i>
                        </blockquote>
                ...
                <p>
                    ...
                    <br/>Újabb tíz év után kezdtem el szülésekhez járni, és azóta számos kórház szülészeti osztályán megfordultam. Az a tapasztalatom, hogy a változások nem mindenhol zajlanak egyformán. Nagy különbségek lehetnek egy fővárosi és egy vidéki kórház szülészetének összehasonlításakor, de akár két budapesti kórház között is.

                    <br/>A különbségek oka egyrészt a tárgyi feltételek milyenségében rejlik, de még ennél is fontosabbak a szemléletbeli különbségek. Többször hallottam már anyáktól, hogy a szülőszobában ugyan volt kád vagy szülőszék, de csak mutatóba, mert nem engedték használni azokat.

                    <br/>A szemléletmód megváltozása ugyan nem pénzkérdés, mégis helyenként nagyon nehezen megy végbe. Ha valaki több évtizede végzi rutinszerűen, az általa megszokott vagy elfogadott szabályok szerint a dolgát, akkor nem könnyű ebből kizökkenteni.

                    <br6></br6>„Túl jól informáltak mostanában az anyák!” – hallottam nemrégiben egy orvostól, aki arról panaszkodott, hogy az internet világában jóval több információ birtokában készülünk a szülésünkre. Számtalan cikket olvashatunk a különböző beavatkozások előnyeiről és hátrányairól, a természetes szülésről, az első órák jelentőségéről, nem is beszélve arról, hogy a különböző kórházakban szerzett tapasztalatainkat is megosztjuk egymással. Egyre több nő ismeri meg a várandósság alatt a lehetőségeit, s így pontosabban meg tudja fogalmazni az igényeit is.
                </p>
                <p>
                    Miért fontos ez?
                </p>
                ...
                <p>
                    <a href="https://nlc.hu/baba/20080304/szeretnek_szepen_szulni/">https://nlc.hu/baba/20080304/szeretnek_szepen_szulni/</a>
                </p>
            </div>
