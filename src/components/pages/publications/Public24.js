...
import Public24Pic1 from "../../../image/publications/public-24-hero-mivel-jar-az-anyasag.png";
import Public24Pic2 from "../../../image/publications/public-24-mivel-jar-az-anyasag.jpg";

export default function Public24() {
  return (
  <div>
    <section className="section-blog-global">
  <div className="blog-global-container">
      <div className="blog-global-hero">
          <img src={Public24Pic1} alt="mivel-jar-az-anyasag"/>
      </div>

      <div className="blog-global-face">
          <h2 className="blog-global-title">Mivel jár az anyaság?</h2>
          ...
          <div className="blog-globale-column">
              <div className="blog-globale-img-container">
                  <img src={Public24Pic2} alt="mivel-jar-az-anyasag"/>
              </div>
              <div className="blog-globale-text">
                  ...
                  <blockquote>
                      <i>"Néhány hónapja született meg első gyermekem, egy csodálatos kislányt, akit nagyon vártunk és szeretünk mindketten a párommal. Születésével egy új életszakaszba léptem, és az anyaság, mely kimondhatatlanul sok örömet ad, új gondolatokat, kérdéseket is ébresztett bennem.<br/>
                          Azon gondolkodtam, hogy a szülővé válás -mint folyamat- hoz egy fajta módosult tudatállapot változást. Ahogy körbenézek, szinte mindenki „egyszerűbb” üzemmódban működik. </i>
                  </blockquote>
          ...
          <blockquote>
              <i>A hétköznapok történései, funkciók kerülnek a középpontba, a szellemi magaslatokig, ahol eddig esetleg jártak, csak nagyon ritkán jutnak el ismét. Ez valahogy nem egy akaratlagos dolog, hanem csak úgy megtörténik, főleg, ha hagyják.<br/>
                  <br/>Bevallom őszintén, én mindig is féltem, hogy mi lesz, ha én is elveszítem magam a pisis pelenkák, kialvatlanság, fáradtság árnyékában. Vagyis azt az intenzív intellektuális érdeklődést és kapacitást, ami úgy látom, igenis korlátozódik a legtöbb anyukánál, mindegy, hogy kinek hány diplomája van. A nap szinte egy pillanat alatt eltelik a baba és a háztartás körüli teendőkkel, és mire elérkezik az este, azon kapjuk magunkat, hogy funkció, funkció…napról napra.<br/>
                  <br/>Sok már-anyuka barátnőmön érzem a beszélgetéseink során, hogy a témaválasztásuk is jobbára a baba körül teendőkre irányul, ami egy bizonyos szintig természetes, ám ezen kívül semmi más nem érdekli őket. Miért van ez a szűkülés? Miért veszünk el a hétköznapokban? Miért felejtünk el gondolkodni, szellemi lényként is funkcionálni? És ha már van, akkor ez meddig tart?<br/>
                  <br/>Még a kisbabám a pocakomban volt, amikor megfigyeltem többeken ezt a „csökkentett üzemmód” állapotot. Ez annyira megviselt, hogy a közeli barátaimat arra kértem, amint azt tapasztalják rajtam, hogy a „mit evett, hogy kakilt, milyen virágot szagolt, én hogy és mit takarítottam aznap” típusú témákat esetleg egyáltalán/gyakorta érintenék, azonnal kólintsanak fejbe egy péklapáttal.<br/>
                  <br/>Azt hiszem, ezt a leépülést viselném a legnehezebben. Ennél még az is jobb, hogy ha nem alszom. Talán, ha ezzel tudatosan foglalkozunk, felkészülünk rá, és nem hagyjuk, hogy észrevétlenül bedaráljon minket a napi rutin, akkor nem elveszítjük, hanem kiegészítjük magunkat…Belülről nehéz az embernek nyakon csípnie magát, amikor épp süpped, mert a fizikai test igényei húzzák lefelé, ezért fontos egy állandó külső kontroll, alapvetően egy preventív pszichés felkészítés erre az állapotra, hogy egyáltalán tudjon róla a leendő anyuka, hogy létezik ez a „csökkentett üzemmód”, de van megoldás rá."<br/>
                  <br/>Helga
                  </i>
          </blockquote>
          <p>
          ...
          <p>
              Persze ha az időd engedi, addig is nyugodtan olvass a nevelési kézikönyveken kívül más irodalmat is, járj társaságba, vagy számodra érdekes és inspiráló előadásokra. Nagyon fontos, hogy jól érezd magad, és időnként másfajta élményekkel is fel tudj töltődni.<br/>
              Nekem már viszonylag nagyok a gyermekeim, ezért azt is ajánlom, hogy add át magad azoknak az élményeknek, amelyeket az anyaság ezen korai időszaka ajándékoz, mert gyorsan és visszahozhatatlanul elmúlik ennek a szimbiózisnak a gyönyörűsége.<br/>
          ...
          <p>
              <a href="https://nlc.hu/baba/20090416/mivel_jar_az_anyasag/">https://nlc.hu/baba/20090416/mivel_jar_az_anyasag/</a>
          </p>
      </div>
