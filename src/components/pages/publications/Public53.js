...
import Public53Pic1 from "../../../image/publications/public-53-hero-egykisfiu-erkezesere-varva.png";
import Public53Pic2 from "../../../image/publications/public-53-egy-kisfiu-erkezesere-varva.jpg";

export default function Public53() {
  return (
  <div>
    <section className="section-blog-global">
        <div className="blog-global-container">
            <div className="blog-global-hero">
                <img src={Public53Pic1} alt="egy-kisfiu-erkezesere-varva"/>
            </div>

            <div className="blog-global-face">
                <h2 className="blog-global-title">Egy kisfiú érkezésére várva</h2>
                ...
                <div className="blog-globale-column">
                    <div className="blog-globale-img-container">
                        <img src={Public53Pic2} alt="egy-kisfiu-erkezesere-varva"/>
                    </div>
                    <div className="blog-globale-text">
                        <p>
                            <b>Itt ülök a számítógépemnél. Most nem levélre válaszolok, az élet írja a következő cikket. Még nem tudom, milyen hosszú lesz, ha holnap szüléshez megyek, a leadásig már nem is tudom befejezni. Akkor majd a jövő héten mesélem tovább Nóri történetét.</b>
                        </p>
                        <p>
                            Szombat este van.
                        </p>
