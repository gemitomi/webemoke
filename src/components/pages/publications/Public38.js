...
import Public38Pic1 from "../../../image/publications/public-38-hero-ovodai-beszoktatas.png";
import Public38Pic2 from "../../../image/publications/public-38-ovodai-beszoktatas.jpg";

export default function Public38() {
  return (
  <div><section className="section-blog-global">
  <div className="blog-global-container">
      <div className="blog-global-hero">
          <img src={Public38Pic1} alt="ovodai-beszoktatas"/>
      </div>

      <div className="blog-global-face">
          <h2 className="blog-global-title">Óvodai beszoktatás</h2>
          ...
          <div className="blog-globale-column">
              <div className="blog-globale-img-container">
                  <img src={Public38Pic2} alt="ovodai-beszoktatas"/>
              </div>
              <div className="blog-globale-text">
                  <p>
                      <b>Immár vége a nyárnak. Kezdődik az oviban is az új nevelési év. Bár Eszter lányom már a nagycsoportot kezdi, mostanában mégis egyre gyakrabban jutnak eszembe azok a szeptemberi napok, amikor a lányaimat először vittem az óvodába.</b>
                  </p>
                  <p>
          ...
          <p>
              ...
              <br/>Az óvodaérettség egyik jele, ha azt tapasztaljuk, hogy a gyermekünk szívesen tölt el egy kis időt tőlünk távol. Ha örömmel megy el a nagyszülőkhöz, vagy szívesen játszik a szomszédban az ott lakó kisgyerekkel, akkor vélhetőleg könnyebb dolgunk lesz, mint ha azt éljük át, hogy a gyermekünk még szinte minden percet velünk akar tölteni.

              <br/>A gyerekek jelentős része csak 4-5 éves korában válik óvodaéretté, ez az a kor, amikor már igazán élvezik a közösségi játékokat, a 3 éves gyermekek inkább még egymás mellett játszanak.
          </p>
          <p>
          ...
          <p>
              <a href="https://nlc.hu/baba/20080902/ovodai_beszoktatas/">https://nlc.hu/baba/20080902/ovodai_beszoktatas/</a>
          </p>
      </div>
