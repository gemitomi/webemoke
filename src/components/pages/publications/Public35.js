...
import Public35Pic1 from "../../../image/publications/public-35-hero-terhes-vagyok-hogyan-tovabb.png";
import Public35Pic2 from "../../../image/publications/public-35-terhes-vagyok-hogyan-tovabb.jpg";

export default function Public35() {
  return (
  <div><section className="section-blog-global">
  <div className="blog-global-container">
      <div className="blog-global-hero">
          <img src={Public35Pic1} alt="terhes vagyok, hogyan tovabb"/>
      </div>

      <div className="blog-global-face">
          <h2 className="blog-global-title">Terhes vagyok, hogyan tovább?</h2>
          ...
          <div className="blog-globale-column">
              <div className="blog-globale-img-container">
                  <img src={Public35Pic2} alt="terhes vagyok, hogyan tovabb"/>
              </div>
              <div className="blog-globale-text">
                  ...
                  <blockquote>
                      <i>A múlt héten bizonyosodott be, hogy kisbabát várok, mert a teszt pozitív lett! A várandósságom a számításom szerint a 6. hetében jár. Mivel az első babámat várom, örülnék, ha segítenél eligazodni abban, hogy a várandósságom alatt milyen vizsgálatokon kell majd megjelennem.<br/>
                          Terhes vagyok, hogyan tovább?<br/>
                      <br/>Válaszodat előre is köszönöm!<br/>Anita</i>
                  </blockquote>
          ...
          <p>
              <b>Az első vérvételen a következő vizsgálatokat végzik:</b>
          </p>
          <p>
          ...
          <ul className="blog-globale-list">
              <li className="blog-globale-has-before">testsúlymérés,</li>
              <li className="blog-globale-has-before">vérnyomásmérés,</li>
              <li className="blog-globale-has-before">pulzusszámmérés,</li>
              <li className="blog-globale-has-before">haskörfogat mérése,</li>
              <li className="blog-globale-has-before">symphisis-fundus távolság (SF) mérése a 20. héttől</li>
              <li className="blog-globale-has-before">és a magzati szívhang észlelése (babydoppal már a 12-14. héttől észlelhető).</li>
          ...
          <p>
              <a href="https://nlc.hu/baba/20081104/terhes_vagyok_hogyan_tovabb/">https://nlc.hu/baba/20081104/terhes_vagyok_hogyan_tovabb/</a>
          </p>
      </div>
