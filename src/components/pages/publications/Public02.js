...
import Public02Pic1 from "../../../image/publications/public-02-hero-indulas-erkezes.jpg";
import Public02Pic2 from "../../../image/publications/public-02-indulas-erkezes.png";

export default function Public02() {
    return (
        <div>
          <section className="section-blog-global">
        <div className="blog-global-container">
            <div className="blog-global-hero">
                <img src={Public02Pic1} alt="Indulas-erkezes"/>
            </div>

            <div className="blog-global-face">
                <h2 className="blog-global-title">Indulás, érkezés</h2>
                ...
                <div className="blog-globale-column">
                    <div className="blog-globale-img-container">
                        <img src={Public02Pic2} alt="Indulas-erkezes"/>
                    </div>
                    <div className="blog-globale-text">
                        <p>
                            <b>Megcsördül a telefonom. Mire az ágyból érte nyúlok, már teljesen éber vagyok, és tudom, hogy mennem kell. Az ébresztőórára pillantok: éjjel fél kettő.</b>
                        </p>
                        <p>
                ...
                <p>
                    Sietősre fogom. Kabát, kesztyű, kocsikulcs. A dúlatáskám már az autóban, az autó a kertünkben. A hó alatt. Merthogy esik, és errefelé nem is kicsit. Hatalmas pelyhekben hullik a csend az éjszakára, így festve sűrű pöttyökkel fehérre a sötétet. Annyira szép! Vidám vagyok és eszembe jut, hogy hóesésben még sohasem mentem szüléshez. Lesöpröm a havat a szélvédőről és az arcomra fagy a mosoly, mint a vízpára az üvegre. A szélvédőn ugyanis vastagon áll a jég.
                </p>
                <p>
                ...
                <p>
                    Különös lehet mindig éjjel dolgozni. A lakóházak ablakai sötétek, az emberek nagy többsége ilyenkor általában alszik, s talán sosem gondolnak azokra, akik éjjelente teszik a dolgukat.<br/> Megérkezem a kórház melletti parkolóba, majd néhány perc múlva Olgáék autója is feltűnik.
                </p>
                <p>
                    <i>„Mindig azt képzeltem, hogy esni fog a hó, amikor a kislányunk megszületik.” </i>– mondja Olga, amikor a méhösszehúzódások szüneteiben apró lépésekkel közeledünk a kórház bejáratához. Látom az arcán, hogy valójában ő már egy másik világban jár.<br/>
                ...
                <p>
                    <i>„De jó, hogy elindultunk, hiszen a babád hamarosan megérkezik!”</i>- súgom neki megkönnyebbült mosollyal.
                </p>
                <p>
                ...
                <p>
                    <a href="https://nlc.hu/baba/20100202/indulas_erkezes/">https://nlc.hu/baba/20100202/indulas_erkezes/</a>
                </p>
            </div>
