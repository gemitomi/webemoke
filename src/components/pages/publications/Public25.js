...
import Public25Pic1 from "../../../image/publications/public-25-hero-abris-szuletesnapjan.png";
import Public25Pic2 from "../../../image/publications/public-25-abris-szuletesnapjan.png";

export default function Public25() {
  return (
  <div><section className="section-blog-global">
  <div className="blog-global-container">
      <div className="blog-global-hero">
          <img src={Public25Pic1} alt="abris-szuletesnapjan"/>
      </div>

      <div className="blog-global-face">
          <h2 className="blog-global-title">Ábris születésnapján</h2>
          ...
          <div className="blog-globale-column">
              <div className="blog-globale-img-container">
                  <img src={Public25Pic2} alt="abris-szuletesnapjan"/>
              </div>
              <div className="blog-globale-text">
                  <p>
                      <b>Egy távoli városkában él egy kisfiú, Ábris. Anyukájával akkor ismerkedtem meg, amikor őt várta, és bár a szülésig nem találkoztunk túl gyakran, nagyon hamar közel kerültünk egymáshoz.</b>
                  </p>
                  <p>
          ...
          <p>
              Hamarosan úgy tűnt, hogy ő is megtalálta a helyét, a vajúdás szép ritmusba rendeződött. Talán segítette ezt az otthonról hozott zene is, amelyre lassan, összebújva táncoltak a párjával. Egy jó óra múlva fürdőt készítettem, abban bízva, hogy a víz jó hatással lesz erősödő, de nem sűrűsödő fájdalmaira. Szinte abban a pillanatban, ahogy beleült a meleg vízbe, az arca elsimult. Szemeit lehunyta, nem beszélt már hozzánk, csak magára és a babára figyelt.
          </p>
          <p>
              Nagyon szép volt. Leültünk a párjával a kád mellé, és néztük a gyertyafényben, ahogy a kontrakciók idején Márti a levegőbe emelt kezével intve gondolatban terelgeti lefelé a babáját, néha-néha hangot is adva neki: <i>„Lefelé, kifelé!”</i>
          </p>
          <p>
          ...
          <p>
              Sok mindent megpróbáltunk. Masszíroztam, borogatást készítettem, végül Márti az orvos javaslatára a burokrepesztésbe is beleegyezett. Ez a kontrakciókat nagyon intenzívvé tette, de a tágulás mégsem haladt tovább. Tudtuk, hogy a korábbi császármetszése és egy fogós szülése után most nagyon szeretné természetes úton megszülni a babáját. 
          </p>
          <p>
              A szülésznő lassan és érthetően megbeszélte vele a lehetőségeket. Megegyeztek, hogy bekötik az epidurális érzéstelenítést, és mivel úgy ítélték meg, hogy nem elég hatékonyak a kontrakciók, oxitocint is kap. Biztatták, hogy ily módon esélye lesz arra, hogy a méhszája kitáguljon és megszülhesse a kisfiát.
          </p>
          <p>
          ...
          <p>
              Teljes csend lett. Melléültem egy vajúdólabdára. Egyik kezemet a dereka alá csúsztattam, hogy enyhítsem a keresztcsontja fájdalmát. Másik kezemért Márti nyúlt, tenyerét a tenyerembe tette, majd lassan lehunyta a szemét.<br/>
              A szomszéd szobában ott hevert a táskám üresen, hisz már minden előkerült belőle, olajok, borogatókendők, homeopátiás szerek, masszírozó labda, inni- és ennivaló.<br/>
          ...
          <p>
              <a href="https://nlc.hu/baba/20090331/bris_szuletesnapjan/">https://nlc.hu/baba/20090331/bris_szuletesnapjan/</a>
          </p>
      </div>
