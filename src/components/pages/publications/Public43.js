...
import Public43Pic1 from "../../../image/publications/public-43-hero-kiseroim.jpg";
import Public43Pic2 from "../../../image/publications/public-43-kiseroim.jpg";

export default function Public43() {
  return  (
    <div>
    <section class="section-blog-global">
        <div class="blog-global-container">
            <div class="blog-global-hero">
                <img src={Public43Pic1}/>
            </div>

            <div class="blog-global-face">
                <h2 class="blog-global-title">Kísérőim</h2>
                ...
                <div class="blog-globale-column">
                    <div class="blog-globale-img-container">
                        <img src={Public43Pic2} alt="kiseroim"/>
                    </div>
                    <div class="blog-globale-text">
                        
                        <p>
                            Alkonyat. A legjobb futóidő. Még süt a nap, de már a horizont közelében jár. Indulok. Két éve rendszeresen, legalább hetente háromszor nekivágok, hogy a testem edzésén kívül lelkileg is megtisztuljak, felfrissüljek.
                            <br/>Az első kilométer ritkán esik igazán jól. Még nagyon a földön vagyok. Nézelődöm, megfigyelem a terepet. Ez az első körben már csak azért sem haszontalan, mert a táv nagy részét aztán szinte teljesen becsukott szemmel teszem meg.
                        </p>
                ...
                <p>
                    assan mindent és mindenkit elhagyok, elmaradoznak a kísérőim. Szétfoszladoznak az arcok, elillannak a gondok. A 10. kilométernél már teljesen egyedül vagyok. Minden alkalommal keményen meg kell dolgoznom ezért a magányért, de nem bánom.
                </p>
                <p>
                ...
                <p>
                    <a href="https://nlc.hu/baba/20080708/kiseroim/">https://nlc.hu/baba/20080708/kiseroim/</a>
                </p>
            </div>
