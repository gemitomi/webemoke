...
import Public56Pic1 from "../../../image/publications/public-56-hero-a-termeszetessegrol.png";
import Public56Pic2 from "../../../image/publications/public-56-a-termeszetessegrol.jpg"
export default function Public56() {
  return (
  <div>
    <section className="section-blog-global">
        <div className="blog-global-container">
            <div className="blog-global-hero">
                <img src={Public56Pic1} alt="a-termeszetessegrol"/>
            </div>

            <div className="blog-global-face">
                <h2 className="blog-global-title">A természetességről</h2>
                ...
                <div className="blog-globale-column">
                    <div className="blog-globale-img-container">
                        <img src={Public56Pic2} alt="a-termeszetessegrol"/>
                    </div>
                    <div className="blog-globale-text">
                        ...
                        <blockquote>
                            <i>Azért írok, mert történt valami, ami gyökeresen megváltoztatta a felfogásomat.
                            <br/>A terhességem alatt folyamatosan olvastam a modern elméleteket, lehetőségeket a szüléssel kapcsolatban, rendszeresen látogattam a Nők Lapja oldalait is, és megdöbbentő felfedezést tettem: még ebben a különleges helyzetben, a várandósság ideje alatt is tervezünk, irányítunk, menedzserkedünk. Mindezt beöltöztetjük a „vissza a természethez” köntösébe, a természetesség jegyében állítjuk össze a szülési tervet, eleve elutasítunk mindent, ami mű, ami megzavarhatja a szülés természetes folyamatát.</i>
                        </blockquote>
                ...
                <p>
                    ...
                    <br/>Természetes-e az, hogy a természetes szülésre készülni kell? Lehet-e tervezni a szülést? Milyen értelemben bízhatjuk magunkat a sorsra? Biztos-e az, hogy bárhogy is lesz, az úgy lesz jó?
                </p>
                <p>
                    Azok a válaszok, amelyek most ezekre az elgondolkodtató kérdésekre megfogalmazódnak bennem, két forrásból táplálkoznak.
                    <br/>Egyrészt mind a három gyermekem érkezését egészen másfajta készülődés előzte meg. Az első szülésemnél még jóval kevesebb információhoz lehetett hozzáférni, és a lehetőségek is sokkal szűkebbre szabottak voltak, a harmadik lányom születésére pedig egészen más feltételek között, aktív dúlaként jóval több ismeret birtokában készültem. Mind számomra, mind a gyermekemre nézve egészen mást jelentett ez a tény.
                    <br/>Másrészt az elmúlt években rengeteg szüléstörténetet hallgattam meg. Ezekben a beszámolókban nemcsak az öröm, a büszkeség és az elégedettség fejeződik ki, hanem gyakran a csalódottság, a megfosztottság, a kiszolgáltatottság érzése is. Nagyon sokan vannak, akik nem azt érzik, hogy ahogy történt, az úgy volt a legjobb.
                    <br/>Egyre többen tervezünk hát a várandósság alatt. Informálódunk a lehetőségeinkről, a kórházakról, az orvosokról, kérdezgetjük egymást a játszótereken, a fodrásznál és az interneten, vagy éppen fórumokat nyitunk a szülészeti osztályokon szerzett tapasztalatainkról.
                </p>
                <p>
                ...
                <p>
                    A biztonságot.
                    <br/>A bizalmat.
                    <br/>Az empátiát és a szeretetteljes odafigyelést.
                    <br/>Azt, hogy a gyermeke világra hozásához méltó körülményeket választhasson, hogy tiszteljék őt, ezeket az órákat, az intimitás iránti igényét, hogy vele maradhasson a kisbabája, hogy segítsék őt a szoptatásban, hogy tájékoztassák mindenről, ami vele és a gyermekével történni fog.
                </p>
                <p>
                ...
                <p>
                    ...
                    <br/>Mindemellett nagy a leterheltség, így a sürgetettség is, és ritkább a türelem. Tapasztalataim szerint teljesen más gyakorlat van ugyanabban a kérdésben az egyik kórházban, mint a másikban, és ezen belül az egyes orvosok is másképp vélekednek egy adott helyzet értékelésénél.
                </p>
                <p>
                    ...
                    <br/>Ott, ahol szakmailag és emberileg is azt kapják a nők, amit szeretnének, jóval magasabb a születésszám.
                    <br/>Meggyőződésem, hogy ha az anyák biztosak lehetnének abban, hogy ők is és a babájuk is mindenhol ugyanazt az ellátást és emberileg ugyanazt a hozzáállást kapják, bármelyik kórházba is mennek, akkor sokkal inkább átadhatnák magukat annak, hogy csak befelé figyeljenek.
                </p>
                <p>
                ...
                <p>
                    ...
                    <br/>Arról meséltél, hogy a te tested is azután kezdett tüneteket produkálni, amikor kiderült, hogy az, ami számodra a biztonságot jelentette volna – a párod jelenléte, a vízben vajúdás lehetősége –, nem elérhető.
                </p>
                <p>
                ...
                <p>
                    <a href="https://nlc.hu/baba/20080116/a_termeszetessegrol/">https://nlc.hu/baba/20080116/a_termeszetessegrol/</a>
                </p>
            </div>
