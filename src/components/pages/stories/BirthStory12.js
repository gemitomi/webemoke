...
import Birth12Pic1 from "../../../image/szulestort/szules_story_12_hero_lakoma_koncert.png";
import Birth12Pic2 from "../../../image/szulestort/szules_story_12_lakoma_koncert.png";

export default function BirthStory12() {
    useEffect(() => {
        window.scrollTo(0, 0)
      }, [])
    return (
        ...
        <div className="blog-global-container">
            <div className="blog-global-hero">
                <img src={Birth12Pic1} alt="Lakoma, koncert, transz, baba"/>
            </div>

            <div className="blog-global-face">
                <h2 className="blog-global-title">Lakoma, koncert, transz, baba</h2>
                ...
                <div className="blog-globale-column">
                    <div className="blog-globale-img-container">
                        <img src={Birth12Pic2} alt="Lakoma, koncert, transz, baba"/>
                    </div>
                ...
                <p>
                    -<i>Bepisiltem.</i>- sziszegtem, majd a pultos hölgyre mosolyogva megkérdeztem, merre találom a vizes blokkot.
                </p>
                <p>
                ...
                <p>
                    -<i>Csilla az.</i>-  mondtam a kijelzőre pillantva.
                </p>
                <p>
                    -<i>Ne vedd fel!</i>- felelte Lacus.
                </p>
                <p>
                    -<i>De biztosan van valami...</i>- motyogtam, és elengedtem a fülem mellett felszólítását.
                </p>
                <p>
                    -<i>Szia, mi újság?</i>- kérdeztem a húgomat – aki tudtam -,  sohasem hív indokolatlanul.
                </p>
                <p>
                    -<i>Szia szívem!</i>- csacsogta. <i>Remélem nem zavarok, de kinnt van az ANTSZ, rutinellenőrzés, és ...</i>
                </p>
                <p>
                ...
                <p>
                    – <i>ihez tartozik ez a kismama? </i>– kiabálja hátra egy orvos a fejemnél megállva.
                </p>
                <p>
                    – <i>Az Orsié.</i> – válaszolja egy hang.
                </p>
                <p>
                    -<i>És hol van Orsi?</i>
                </p>
                ...
                <p>
                    -<i>Akkor szóljatok neki, hogy jöjjön, aztán vigye be innen!</i>
                </p>
                <p>
                ...
                <p>
                    Azt mondják, üljek fel a szülőágyra. Ez képtelenség. A jobbra-balra forgolódás borzalmas kínlódás, ráadásul hasztalannak érzem, és egyre idegesebb leszek tőle.Orsi, a szülésznő azt mondja: “Ne add ki a hangodat! Azt az erőt, add bele a nyomásba!” Hangja meglep. Valami újra áthatolt, és betalált az univerzumom közepébe. Jó érzés tudni, hogy nem vagyok egyedül. A tanács hasznos, erőt ad.Azt mondják, kint van a baba feje, és kérdik meg akarom-e fogni. Dehogy akarom, anélkül is érzem. Inkább azt akarom, hogy végre teljesen kijöjjön belőlemÉrzékelem, ahogyan a karomba adják a picibabát, de nagyon távoli, nem látom jól. Erőtlen vagyok, nem bírom a karomban tartani.
                </p>
                <p>
